...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is __Adam Brandt__ and my major is _Software Engineering_ with a minor in Data Science.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think that a job involving machine learning such as working on driverless cars would relate to data science. Here is a link to an article about machine learning algorithms in [driverless cars](https://iiot-world.com/artificial-intelligence-ml/machine-learning/machine-learning-algorithms-in-autonomous-driving/#:~:text=Autonomous%20cars%20are%20very%20closely%20associated%20with%20Industrial%20IoT.&text=One%20of%20the%20main%20tasks,possible%20changes%20to%20those%20surroundings.) and here is an image of a driverless car: ![](https://media.wired.com/photos/5bd8cb507ab9ab2cf2703985/16:9/w_2400,h_1350,c_limit/Waymo-M4MH7N.jpg)
    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think studying Covid-19 statistics would be interesting since there is a lot of data available and since it has such a large impact on daily life.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: git version 2.21.0.windows.1
    
    
9. Configure your git username and user email by modifying and entering the following commands into the terminal

    ```
    git config --global user.name "Adam Brandt"
    git config --global user.email "abrandt1@iastate.edu"
    ```
...
10. Register a [GitHub](https://www.github.com) account. What is your username?
    ...
    Answer: My username is abrandt1901.